...
public class DbImportTest_HSQL {
	...
	public void tearDown() throws Exception {
		...
		try (Connection connection = DbUtilities.createConnection(new DbDefinition(DbVendor.HSQL, "", HSQL_DB_FILE, "", null), false)) {
			...
			if (DbUtilities.checkTableExist(connection, "test2_tbl")) {
				try (Statement statement = connection.createStatement()) {
					statement.execute("DROP TABLE test2_tbl");
				}
			}
		} catch (final Exception e) {
			e.printStackTrace();
	...
	private void createEmptyTest2Table() throws Exception {
		try (Connection connection = DbUtilities.createConnection(new DbDefinition(DbVendor.HSQL, "", HSQL_DB_FILE, "", null), false);
			...
			statement.execute("CREATE TABLE test2_tbl (id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, " + dataColumnsPart + ")");
		} catch (final Exception e) {
			e.printStackTrace();
			throw e;
		}
		...
		try {
			...
			FileUtilities.write(INPUTFILE_CSV,
					("column integer; column_double; column_varchar; column_blob; column_clob; column_timestamp; column_date\n"
							+ "123; 123.456E0; aBcDeF123; " + Utilities.encodeBase64("abc".getBytes(StandardCharsets.UTF_8)) + "; aBcDeF1234; 01.02.2003 11:12:13; 01.02.2003 21:22:23\n").getBytes(StandardCharsets.UTF_8));
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							+ "1;" + Utilities.encodeBase64("abc".getBytes(StandardCharsets.UTF_8)) + ";aBcDeF1234;2003-02-01;123.456E0;123;2003-02-01 11:12:13.000000;aBcDeF123\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
		...
		try {
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							...
							+ "4;; aBcDeF1235;2003-03-01;123.456E0;4;2003-02-01 11:12:13.000000;\n"
							+ "5;; aBcDeF1235;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000;\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
		...
		try {
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							...
							+ "4;; aBcDeF1235_4;2003-03-01;123.456E0;4;2003-02-01 11:12:13.000000;\n"
							+ "5;; aBcDeF1234;2003-03-01;123.456E0;5;2003-02-01 11:12:13.000000; aBcDeF123_5\n"
							+ "6;; aBcDeF1235_2;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000; aBcDeF123_2\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
		...
		try {
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							...
							+ "2;; aBcDeF1235_3;2003-03-01;123.456E0;3;2003-02-01 11:12:13.000000;\n"
							+ "3;;;;;999;;\"<test_text>_999\"\n"
							+ "7;; aBcDeF1235_4;2003-03-01;123.456E0;4;2003-02-01 11:12:13.000000;\n"
							+ "8;; aBcDeF1234;2003-03-01;123.456E0;5;2003-02-01 11:12:13.000000; aBcDeF123_5\n"
							+ "9;; aBcDeF1235_2;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000;\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
		...
		try {
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							...
							+ "7;; aBcDeF1235_4;2003-03-01;123.456E0;4;2003-02-01 11:12:13.000000;\n"
							+ "8;; aBcDeF1234;2003-03-01;123.456E0;5;2003-02-01 11:12:13.000000; aBcDeF123_5\n"
							+ "9;; aBcDeF1235_2;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000; aBcDeF123_2\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	...
	@Test
	public void testOdsImportUpsert() {
		try {
			createEmptyTestTable();
			prefillTestTable();

			final String mapping = "column_integer='column_integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_blob=; column_timestamp='column_timestamp'; column_date='column_date'";
			Assert.assertEquals(0, DbImport._main(new String[] {
					"hsql",
					"",
					HSQL_DB_FILE,
					"-table", "test_tbl",
					"-x", "ODS",
					"-import", new File(getClass().getResource("Test.ods").getFile()).getAbsolutePath(),
					"-m", mapping,
					"-i", "UPSERT",
					"-k", "column_integer"
			}));
	...
	@Test
	public void testExcel2003Import() {
		try {
			createEmptyTestTable();

			final String mapping = "column_integer='Column integer'; column_double='Column double'; column_varchar='Column varchar'; column_clob='Column clob'; column_blob=; column_timestamp='Column timestamp'dd.MM.yyyy HH:mm:ss; column_date='Column date'dd.MM.yyyy HH:mm:ss";
			Assert.assertEquals(0, DbImport._main(new String[] {
					"hsql",
					"",
					HSQL_DB_FILE,
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test_Excel2003.xls").getFile()).getAbsolutePath(),
					"-x", "EXCEL",
					"-m", mapping
			}));
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							+ "1;; aBcDeF1234;2003-03-01;123.456E0;1;2003-02-01 11:12:13.000000; aBcDeF123_1\n"
							+ "2;; aBcDeF1235_1;2003-03-01;123.456E0;1;2003-02-01 11:12:13.000000;\n"
							+ "3;; aBcDeF1234;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000; aBcDeF123_2\n"
							+ "4;; aBcDeF1235_2;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000;\n"
							+ "5;; aBcDeF1234;2003-03-01;123.456E0;3;2003-02-01 11:12:13.000000; aBcDeF123_3\n"
							+ "6;; aBcDeF1235_3;2003-03-01;123.456E0;3;2003-02-01 11:12:13.000000;\n"
							+ "7;; aBcDeF1235_4;2003-03-01;123.456E0;4;2003-02-01 11:12:13.000000;\n"
							+ "8;; aBcDeF1234;2003-03-01;123.456E0;5;2003-02-01 11:12:13.000000; aBcDeF123_5\n",
							exportTestTable());
		} catch (final Exception e) {
	...
	@Test
	public void testExcel2007Import() {
		try {
			createEmptyTestTable();
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					HSQL_DB_FILE,
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test_Excel2007.xlsx").getFile()).getAbsolutePath(),
					"-x", "EXCEL",
					"-m", mapping
			}));
			Assert.assertEquals(
	...
	public void testCsvZipImport() {
		try {
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					HSQL_DB_FILE,
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test.csv.zip").getFile()).getAbsolutePath(),
					"-m", mapping
			}));
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
	...
	@Test
	public void testCsvZipWithPasswordZipCryptoImport() {
		try {
			createEmptyTestTable();
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					HSQL_DB_FILE,
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test_ZipCrypto_Password_abc123.csv.zip").getFile()).getAbsolutePath(),
					"-zippassword", "abc123",
					"-m", mapping
			}));
			Assert.assertEquals(
	...
	@Test
	public void testCsvZipWithPasswordAES256Import() {
		try {
			createEmptyTestTable();
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					HSQL_DB_FILE,
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test_AES-256_Password_abc123.csv.zip").getFile()).getAbsolutePath(),
					"-zippassword", "abc123",
					"-m", mapping
			}));
			Assert.assertEquals(
	...
	@Test
	public void testCsvImportByFilename() {
		try {
			createEmptyTestTable();
			prefillTestTable();
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							+ "4;; aBcDeF1234;2003-03-01;123.456E0;1;2003-02-01 11:12:13.000000; aBcDeF123\n"
							+ "5;; aBcDeF1235;2003-03-01;123.456E0;1;2003-02-01 11:12:13.000000;\n"
							+ "6;; aBcDeF1234;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000; aBcDeF123\n"
							+ "7;; aBcDeF1235;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000;\n"
							+ "8;; aBcDeF1234;2003-03-01;123.456E0;3;2003-02-01 11:12:13.000000; aBcDeF123\n"
							+ "9;; aBcDeF1235;2003-03-01;123.456E0;3;2003-02-01 11:12:13.000000;\n"
							+ "10;; aBcDeF1235;2003-03-01;123.456E0;4;2003-02-01 11:12:13.000000;\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	...
	@Test
	public void testCsvImportWithDefinedDateFormat() {
		try {
			createEmptyTestTable();
			prefillTestTable();
			...
			final StringBuilder data = new StringBuilder();
			data.append("column_integer; column_double; column_varchar; column_clob; column_timestamp; column_date\n");
			data.append((i) + "; 123.456E0; aBcDeF123; aBcDeF1234; 2003-02-01 11:12:13; 2003-03-01\n");
			data.append((i++) + "; 123.456E0;; aBcDeF1235; 2003-02-01 11:12:13; 2003-03-01\n");
			data.append((i) + "; 123.456E0; aBcDeF123; aBcDeF1234; 2003-02-01 11:12:13; 2003-03-01\n");
			data.append((i++) + "; 123.456E0;; aBcDeF1235; 2003-02-01 11:12:13; 2003-03-01\n");
			data.append((i) + "; 123.456E0; aBcDeF123; aBcDeF1234; 2003-02-01 11:12:13; 2003-03-01\n");
			data.append((i++) + "; 123.456E0;; aBcDeF1235; 2003-02-01 11:12:13; 2003-03-01\n");
	...
	@Test
	public void testCsvImportWithDefinedDateFormatAnDateWithTime() {
		try {
			createEmptyTestTable();
			prefillTestTable();
			...
			final StringBuilder data = new StringBuilder();
			data.append("column_integer; column_double; column_varchar; column_clob; column_timestamp; column_date\n");
			data.append((i) + "; 123.456E0; aBcDeF123; aBcDeF1234; 2003-02-01 11:12:13; 2003-03-01 02:00\n");
			data.append((i++) + "; 123.456E0;; aBcDeF1235; 2003-02-01 11:12:13; 2003-03-01 02:00\n");
			data.append((i) + "; 123.456E0; aBcDeF123; aBcDeF1234; 2003-02-01 11:12:13; 2003-03-01 02:00\n");
			data.append((i++) + "; 123.456E0;; aBcDeF1235; 2003-02-01 11:12:13; 2003-03-01 02:00\n");
			data.append((i) + "; 123.456E0; aBcDeF123; aBcDeF1234; 2003-02-01 11:12:13; 2003-03-01 02:00\n");
			data.append((i++) + "; 123.456E0;; aBcDeF1235; 2003-02-01 11:12:13; 2003-03-01 02:00\n");
	...
	@Test
	public void testCsvImportWithDefinedDateFormatAndTimeZones() {
		try {
			createEmptyTestTable();
			prefillTestTable();
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							+ "4;; aBcDeF1234;2003-03-01;123.456E0;1;2003-02-01 12:12:13.000000; aBcDeF123\n"
							+ "5;; aBcDeF1235;2003-03-01;123.456E0;1;2003-02-01 12:12:13.000000;\n"
							+ "6;; aBcDeF1234;2003-03-01;123.456E0;2;2003-02-01 12:12:13.000000; aBcDeF123\n"
							+ "7;; aBcDeF1235;2003-03-01;123.456E0;2;2003-02-01 12:12:13.000000;\n"
							+ "8;; aBcDeF1234;2003-03-01;123.456E0;3;2003-02-01 12:12:13.000000; aBcDeF123\n"
							+ "9;; aBcDeF1235;2003-03-01;123.456E0;3;2003-02-01 12:12:13.000000;\n"
							+ "10;; aBcDeF1235;2003-03-01;123.456E0;4;2003-02-01 12:12:13.000000;\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		}
	...
	@Test
	public void testCsvImportWithDefinedDateFormatAndMultipleFiles() {
		try {
			createEmptyTestTable();
			prefillTestTable();
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							+ "1;; aBcDeF1234;2003-03-01;123.456E0;1;2003-02-01 11:12:13.000000; aBcDeF123\n"
							+ "2;; aBcDeF1235;2003-03-01;123.456E0;1;2003-02-01 11:12:13.000000;\n"
							+ "3;; aBcDeF1234;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000; aBcDeF123\n"
							+ "4;; aBcDeF1235;2003-03-01;123.456E0;2;2003-02-01 11:12:13.000000;\n"
							+ "5;; aBcDeF1234;2003-03-01;123.456E0;3;2003-02-01 11:12:13.000000; aBcDeF123\n"
	...
	public void testVcfImport() {
		try {
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					"-table", "test_tbl",
					"-x", "VCF",
					"-import", new File(getClass().getResource("Test.vcf").getFile()).getAbsolutePath()
			}));
	...
	public void testTarGzImport() {
		try {
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					"-create",
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test.csv.tar.gz").getFile()).getAbsolutePath(),
					"-m", "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss"
			}));
	...
	public void testGzImport() {
		try {
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					"-create",
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test.csv.gz").getFile()).getAbsolutePath(),
					"-m", "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss"
			}));
	...
	public void testTgzImport() {
		try {
			...
			Assert.assertEquals(0, DbImport._main(new String[] {
					...
					"-create",
					"-table", "test_tbl",
					"-import", new File(getClass().getResource("Test.csv.tgz").getFile()).getAbsolutePath(),
					"-m", "column_integer='column integer'; column_double='column_double'; column_varchar='column_varchar'; column_clob='column_clob'; column_timestamp='column_timestamp'dd.MM.yyyy HH:mm:ss; column_date='column_date'dd.MM.yyyy HH:mm:ss"
			}));
	...
	@Test
	public void testCsvImportInsertTarGzFile() {
		final File data_file_1 = new File(TEMP_DIR, "test1.blob");
		final File data_file_1_targz = new File(TEMP_DIR, "test1.blob.tar.gz");
		final File data_file_2 = new File(TEMP_DIR, "test2.blob");
		final File data_file_2_targz = new File(TEMP_DIR, "test2.blob.tar.gz");

		try {
			createEmptyTestTable();
			prefillTestTable();

			if (data_file_1.exists()) {
				data_file_1.delete();
			}
			if (data_file_1_targz.exists()) {
				data_file_1_targz.delete();
			}
			FileUtilities.write(data_file_1, (TextUtilities.GERMAN_TEST_STRING + "1").getBytes(StandardCharsets.UTF_8));
			TarGzUtilities.compress(data_file_1_targz, data_file_1);

			if (data_file_2.exists()) {
				data_file_2.delete();
			}
			if (data_file_2_targz.exists()) {
				data_file_2_targz.delete();
			}
			FileUtilities.write(data_file_2, (TextUtilities.GERMAN_TEST_STRING + "2").getBytes(StandardCharsets.UTF_8));
			TarGzUtilities.compress(data_file_2_targz, data_file_2);
			...
			Assert.assertEquals(
					"ID;COLUMN_BLOB;COLUMN_CLOB;COLUMN_DATE;COLUMN_DOUBLE;COLUMN_INTEGER;COLUMN_TIMESTAMP;COLUMN_VARCHAR\n"
							+ "1;;\"<test_text>1\";;;1;;Update\n"
							+ "2;;;;;3;;\"<test_text>_3\"\n"
							+ "3;;;;;999;;\"<test_text>_999\"\n"
							+ "4;;\"<test_text>2\";;;2;;Insert\n",
							exportTestTable());
		} catch (final Exception e) {
			Assert.fail(e.getMessage());
		} finally {
	...
	@Test
	public void testJsonImportUpsertWithoutDatatypeParameter() {
		JsonWriter jsonWriter = null;
		try {
			createEmptyTestTable();
			prefillTestTable();
